  ...
  return (
    <div className="main">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to RegenesisDoc LLC, 2892 Mountain Industrial
            Blvd, Tucker, GA 30084, USA.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to SlimAtlanta, accessible from{' '}
            <a
              href="slimatlanta.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              SlimAtlanta.com by ReGenesisDoc LLC
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        Service by Email or through the following Third-party Social Media Services:
      </p>
      <ul>
        <li>Google</li>
        <li>Facebook</li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            such as a mobile application push notifications regarding updates or
      ...
      <p>
        ...
        require Your parent consent before We collect and use that information.
      </p>
      <h1>Links to Other Websites</h1>
      <p>
        Our Service may contain links to other websites that are not operated by
        Us. If You click on a third party link, You will be directed to that
        third party site. We strongly advise You to review the Privacy Policy of
      ...
      <ul>
        <li>By visiting this page on our website: SlimAtlanta.com</li>
      </ul>
